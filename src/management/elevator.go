...
// initalizes the elev struct and elevator channels
...
func (elev *Elevator) GetOrderActiveStatus(floor, button int) bool {
	return elev.orders[floor][button].GetActiveStatus()
}
